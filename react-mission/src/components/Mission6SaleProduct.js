...
import { Mission6Api } from "../api/api";
import searchIcon from "./img/searchIcon.png";
import useAsync from "./hook/useAsync";

function Mission6SaleProduct() {
  const [items, setItems] = useState([]);
  const [logingError, logingErrorTag, apiAsync] = useAsync(Mission6Api);
...
export default Mission6SaleProduct;
