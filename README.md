...
### 중고마켓 페이지
 ...
 - [X] 상품 데이터는 [https://panda-market-api.vercel.app/docs/](https://panda-market-api.vercel.app/docs/#/)에 명세된 GET 메소드 “/products” 를 사용해주세요.
...
## 공통
- [X] 커스텀 hook을 만들어 필요한 곳에 활용해 보세요. (Product.js)
...
## 스크린샷
### **데스크탑 1800px 기준**
![image](https://github.com/user-attachments/assets/2df9f888-ba6d-415c-8ccd-cc41a63cc1db)

### **태블릿 800px 기준**
![image](https://github.com/user-attachments/assets/40c85c9b-5814-49e4-b8bb-f1617584800b)

### **모바일 400px 기준**
![image](https://github.com/user-attachments/assets/08a7d8d3-9a5b-4ff1-a9a5-311a5b477bd0)

### **좋아요 순 정렬 - 데스크탑 1800px 기준**
![image](https://github.com/user-attachments/assets/13b28913-ccd2-42ac-afd6-e4b8692090d4)

### **키워드 `판다`  검색 - 데스크탑 1800px 기준**
![image](https://github.com/user-attachments/assets/120653db-225a-49c5-ab94-61015e827e65)
