...
// export function disabledBtn(id, pwd) {
//     if (email_regex.test(id.value) && pwdRegex.test(pwd.value)) {
//         return true;
//     } else {
//         return false;
//     }
...
export function disabledBtn(arr) {

    Array.from(arr).forEach((er) => {
        if (!er.value) {
