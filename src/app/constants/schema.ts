...
const MIN_LENGTH_PRODUCT_NAME: number = 1;
const MAX_LENGTH_PRODUCT_NAME: number = 50;
const MIN_LENGTH_PRODUCT_DESCRIPTION: number = 1;
const MAX_LENGTH_PRODUCT_DESCRIPTION: number = 1024;
const MIN_VALUE_PRODUCT_PRICE: number = 1;
const MAX_VALUE_PRODUCT_PRICE: number = 9999999999;
...
export const productSchema: { [id: string]: number } = {
  ...
  MIN_VALUE_PRODUCT_PRICE,
  MAX_VALUE_PRODUCT_PRICE,
};
...
const MIN_LENGTH_PRODUCT_COMMENT_CONTENT: number = 1;
const MAX_LENGTH_PRODUCT_COMMENT_CONTENT: number = 1024;

export const productCommentSchema: { [id: string]: number } = {
  MIN_LENGTH_PRODUCT_COMMENT_CONTENT,
  MAX_LENGTH_PRODUCT_COMMENT_CONTENT,
};
