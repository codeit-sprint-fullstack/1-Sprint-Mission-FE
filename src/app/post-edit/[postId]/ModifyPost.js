...
import { modifyPost } from "@/lib/axios";
...
export function ModifyPost({ postId, data }) {
  const [newNameValid, setNewNameValid] = useState(VALID_VALUE);
  ...
  const handleModifyPost = () => {
    ...
    modifyPost(postId, newName, content).then((data) => {
